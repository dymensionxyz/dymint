module github.com/dymensionxyz/dymint/da/bnb
...
replace (
	...
	github.com/ethereum/go-ethereum v1.15.3 => github.com/bnb-chain/op-geth v1.101315.2-0.0.20250213114253-fbecb252643d
