...
type State struct {
	...
	// tendermint.types.ValidatorSet next_validators = 8 [deprecated = true];
	// tendermint.types.ValidatorSet validators = 9 [deprecated = true];
	// tendermint.types.ValidatorSet last_validators = 10 [deprecated = true];
	...
	SequencersSet                    SequencerSet          `protobuf:"bytes,18,opt,name=sequencersSet,proto3" json:"sequencersSet"`
}
...
func (m *State) GetSequencersSet() SequencerSet {
	if m != nil {
		return m.SequencersSet
	}
	return SequencerSet{}
}
...
var fileDescriptor_4b679420add07272 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.SequencersSet.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SequencersSet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SequencersSet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
