...
type Header struct {
	...
	Dym *DymHeader `protobuf:"bytes,15,opt,name=dym,proto3" json:"dym,omitempty"`
}
...
func (m *Header) GetDym() *DymHeader {
	if m != nil {
		return m.Dym
	}
	return nil
...
func (m *DymHeader) Reset()         { *m = DymHeader{} }
func (m *DymHeader) String() string { return proto.CompactTextString(m) }
func (*DymHeader) ProtoMessage()    {}
func (*DymHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe69c538ded4b87f, []int{2}
}
func (m *DymHeader) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DymHeader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DymHeader.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DymHeader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DymHeader.Merge(m, src)
}
func (m *DymHeader) XXX_Size() int {
	return m.Size()
}
func (m *DymHeader) XXX_DiscardUnknown() {
	xxx_messageInfo_DymHeader.DiscardUnknown(m)
}

var xxx_messageInfo_DymHeader proto.InternalMessageInfo

func (m *DymHeader) GetConsensusMessagesHash() []byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DymHeader)(nil), "dymint.DymHeader")
...
var fileDescriptor_fe69c538ded4b87f = []byte{
	...
	,
}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Dym != nil {
		{
			size, err := m.Dym.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DymHeader) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DymHeader) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DymHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Dym", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Dym.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DymHeader) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DymHeader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DymHeader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
