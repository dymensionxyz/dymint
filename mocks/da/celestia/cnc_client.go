...
func (_m *CNCClientI) NamespacedData(ctx context.Context, namespaceID [8]byte, height uint64) ([][]byte, error) {
	ret := _m.Called(ctx, namespaceID, height)

	var r0 [][]byte
	if rf, ok := ret.Get(0).(func(context.Context, [8]byte, uint64) [][]byte); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, [8]byte, uint64) error); ok {
...
func (_m *CNCClientI) NamespacedShares(ctx context.Context, namespaceID [8]byte, height uint64) ([][]byte, error) {
	ret := _m.Called(ctx, namespaceID, height)
...
// SubmitPFD provides a mock function with given fields: ctx, namespaceID, blob, fee, gasLimit
func (_m *CNCClientI) SubmitPFD(ctx context.Context, namespaceID [8]byte, blob []byte, fee int64, gasLimit uint64) (*cnc.TxResponse, error) {
	ret := _m.Called(ctx, namespaceID, blob, fee, gasLimit)

	var r0 *cnc.TxResponse
	if rf, ok := ret.Get(0).(func(context.Context, [8]byte, []byte, int64, uint64) *cnc.TxResponse); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, [8]byte, []byte, int64, uint64) error); ok {
