...
import (
	...
	types "github.com/dymensionxyz/dymint/third_party/dymension/rollapp/types"
)
...
func (_m *MockQueryClient) LatestHeight(ctx context.Context, in *types.QueryGetLatestHeightRequest, opts ...grpc.CallOption) (*types.QueryGetLatestHeightResponse, error) {
	...
	var r0 *types.QueryGetLatestHeightResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryGetLatestHeightRequest, ...grpc.CallOption) (*types.QueryGetLatestHeightResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryGetLatestHeightRequest, ...grpc.CallOption) *types.QueryGetLatestHeightResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryGetLatestHeightResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryGetLatestHeightRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - in *types.QueryGetLatestHeightRequest
...
func (_c *MockQueryClient_LatestHeight_Call) Run(run func(ctx context.Context, in *types.QueryGetLatestHeightRequest, opts ...grpc.CallOption)) *MockQueryClient_LatestHeight_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(*types.QueryGetLatestHeightRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockQueryClient_LatestHeight_Call) Return(_a0 *types.QueryGetLatestHeightResponse, _a1 error) *MockQueryClient_LatestHeight_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueryClient_LatestHeight_Call) RunAndReturn(run func(context.Context, *types.QueryGetLatestHeightRequest, ...grpc.CallOption) (*types.QueryGetLatestHeightResponse, error)) *MockQueryClient_LatestHeight_Call {
	_c.Call.Return(run)
	return _c
}
