...
import (
	...
	client "github.com/dymensionxyz/dymint/da/celestia/client"
...
func (_m *MockDAClient) GetByHeight(ctx context.Context, height uint64) (*client.ExtendedHeader, error) {
	...
	var r0 *client.ExtendedHeader
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*client.ExtendedHeader, error)); ok {
		return rf(ctx, height)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) *client.ExtendedHeader); ok {
		r0 = rf(ctx, height)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.ExtendedHeader)
		}
	}
...
func (_c *MockDAClient_GetByHeight_Call) Return(_a0 *client.ExtendedHeader, _a1 error) *MockDAClient_GetByHeight_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDAClient_GetByHeight_Call) RunAndReturn(run func(context.Context, uint64) (*client.ExtendedHeader, error)) *MockDAClient_GetByHeight_Call {
	_c.Call.Return(run)
	return _c
}

// GetIDs provides a mock function with given fields: ctx, height, namespace
func (_m *MockDAClient) GetIDs(ctx context.Context, height uint64, namespace []byte) (*client.GetIDsResult, error) {
	...
	var r0 *client.GetIDsResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, []byte) (*client.GetIDsResult, error)); ok {
		return rf(ctx, height, namespace)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, []byte) *client.GetIDsResult); ok {
		r0 = rf(ctx, height, namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.GetIDsResult)
		}
	}
...
func (_c *MockDAClient_GetIDs_Call) Return(_a0 *client.GetIDsResult, _a1 error) *MockDAClient_GetIDs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDAClient_GetIDs_Call) RunAndReturn(run func(context.Context, uint64, []byte) (*client.GetIDsResult, error)) *MockDAClient_GetIDs_Call {
	_c.Call.Return(run)
	return _c
}
