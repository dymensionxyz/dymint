...
func (_m *MockCelestiaRPCClient) GetSignerBalance(ctx context.Context) (*struct {
...
func (_c *MockCelestiaRPCClient_GetSignerBalance_Call) Return(_a0 *struct {
	Denom  string   `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Amount math.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=Int" json:"amount"`
}, _a1 error) *MockCelestiaRPCClient_GetSignerBalance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCelestiaRPCClient_GetSignerBalance_Call) RunAndReturn(run func(context.Context) (*struct {
	Denom  string   `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Amount math.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=Int" json:"amount"`
}, error)) *MockCelestiaRPCClient_GetSignerBalance_Call {
	_c.Call.Return(run)
	return _c
}
