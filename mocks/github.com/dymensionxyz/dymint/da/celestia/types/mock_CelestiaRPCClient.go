...
func (_m *MockCelestiaRPCClient) GetHeaders(ctx context.Context, height uint64) (*header.ExtendedHeader, error) {
...
// MockCelestiaRPCClient_GetHeaders_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHeaders'
type MockCelestiaRPCClient_GetHeaders_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - height uint64
func (_e *MockCelestiaRPCClient_Expecter) GetHeaders(ctx interface{}, height interface{}) *MockCelestiaRPCClient_GetHeaders_Call {
	return &MockCelestiaRPCClient_GetHeaders_Call{Call: _e.mock.On("GetHeaders", ctx, height)}
}

func (_c *MockCelestiaRPCClient_GetHeaders_Call) Run(run func(ctx context.Context, height uint64)) *MockCelestiaRPCClient_GetHeaders_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCelestiaRPCClient_GetHeaders_Call) Return(_a0 *header.ExtendedHeader, _a1 error) *MockCelestiaRPCClient_GetHeaders_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCelestiaRPCClient_GetHeaders_Call) RunAndReturn(run func(context.Context, uint64) (*header.ExtendedHeader, error)) *MockCelestiaRPCClient_GetHeaders_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockCelestiaRPCClient) Submit(ctx context.Context, blobs []*blob.Blob, options *client.SubmitOptions) (uint64, error) {
...
func (_c *MockCelestiaRPCClient_Submit_Call) Run(run func(ctx context.Context, blobs []*blob.Blob, options *client.SubmitOptions)) *MockCelestiaRPCClient_Submit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*blob.Blob), args[2].(*client.SubmitOptions))
	})
	return _c
}
...
func (_c *MockCelestiaRPCClient_Submit_Call) RunAndReturn(run func(context.Context, []*blob.Blob, *client.SubmitOptions) (uint64, error)) *MockCelestiaRPCClient_Submit_Call {
	_c.Call.Return(run)
	return _c
}

// SubmitPayForBlob provides a mock function with given fields: ctx, fee, gasLim, blobs
func (_m *MockCelestiaRPCClient) SubmitPayForBlob(ctx context.Context, fee math.Int, gasLim uint64, blobs []*blob.Blob) (*sdk.TxResponse, error) {
...
// MockCelestiaRPCClient_SubmitPayForBlob_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SubmitPayForBlob'
type MockCelestiaRPCClient_SubmitPayForBlob_Call struct {
	*mock.Call
}

// SubmitPayForBlob is a helper method to define mock.On call
//   - ctx context.Context
//   - fee math.Int
//   - gasLim uint64
//   - blobs []*blob.Blob
func (_e *MockCelestiaRPCClient_Expecter) SubmitPayForBlob(ctx interface{}, fee interface{}, gasLim interface{}, blobs interface{}) *MockCelestiaRPCClient_SubmitPayForBlob_Call {
	return &MockCelestiaRPCClient_SubmitPayForBlob_Call{Call: _e.mock.On("SubmitPayForBlob", ctx, fee, gasLim, blobs)}
}

func (_c *MockCelestiaRPCClient_SubmitPayForBlob_Call) Run(run func(ctx context.Context, fee math.Int, gasLim uint64, blobs []*blob.Blob)) *MockCelestiaRPCClient_SubmitPayForBlob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(math.Int), args[2].(uint64), args[3].([]*blob.Blob))
	})
	return _c
}

func (_c *MockCelestiaRPCClient_SubmitPayForBlob_Call) Return(_a0 *sdk.TxResponse, _a1 error) *MockCelestiaRPCClient_SubmitPayForBlob_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCelestiaRPCClient_SubmitPayForBlob_Call) RunAndReturn(run func(context.Context, math.Int, uint64, []*blob.Blob) (*sdk.TxResponse, error)) *MockCelestiaRPCClient_SubmitPayForBlob_Call {
	_c.Call.Return(run)
	return _c
}
