...
func (_m *MockSolanaClient) GetSignerBalance() (*big.Int, error) {
	ret := _m.Called()
...
// MockSolanaClient_GetSignerBalance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSignerBalance'
type MockSolanaClient_GetSignerBalance_Call struct {
	*mock.Call
}

// GetSignerBalance is a helper method to define mock.On call
func (_e *MockSolanaClient_Expecter) GetSignerBalance() *MockSolanaClient_GetSignerBalance_Call {
	return &MockSolanaClient_GetSignerBalance_Call{Call: _e.mock.On("GetSignerBalance")}
}

func (_c *MockSolanaClient_GetSignerBalance_Call) Run(run func()) *MockSolanaClient_GetSignerBalance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSolanaClient_GetSignerBalance_Call) Return(_a0 *big.Int, _a1 error) *MockSolanaClient_GetSignerBalance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSolanaClient_GetSignerBalance_Call) RunAndReturn(run func() (*big.Int, error)) *MockSolanaClient_GetSignerBalance_Call {
	_c.Call.Return(run)
	return _c
}
