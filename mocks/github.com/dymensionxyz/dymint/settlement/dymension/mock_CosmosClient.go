...
func (_m *MockCosmosClient) GetChainID() string {
	ret := _m.Called()
...
func (_c *MockCosmosClient_GetChainID_Call) Return(_a0 string) *MockCosmosClient_GetChainID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCosmosClient_GetChainID_Call) RunAndReturn(run func() string) *MockCosmosClient_GetChainID_Call {
	_c.Call.Return(run)
	return _c
}
