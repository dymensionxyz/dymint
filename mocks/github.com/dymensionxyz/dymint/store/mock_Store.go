...
func (_m *MockStore) LoadDRSVersion(height uint64) (string, error) {
	ret := _m.Called(height)
...
func (_c *MockStore_LoadDRSVersion_Call) Return(_a0 string, _a1 error) *MockStore_LoadDRSVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_LoadDRSVersion_Call) RunAndReturn(run func(uint64) (string, error)) *MockStore_LoadDRSVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStore) SaveDRSVersion(height uint64, version string, batch store.KVBatch) (store.KVBatch, error) {
...
func (_c *MockStore_SaveDRSVersion_Call) Run(run func(height uint64, version string, batch store.KVBatch)) *MockStore_SaveDRSVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStore_SaveDRSVersion_Call) RunAndReturn(run func(uint64, string, store.KVBatch) (store.KVBatch, error)) *MockStore_SaveDRSVersion_Call {
	_c.Call.Return(run)
	return _c
}
