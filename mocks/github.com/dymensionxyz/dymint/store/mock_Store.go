...
// MockStore_Run3DMigration_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Run3DMigration'
type MockStore_Run3DMigration_Call struct {
	*mock.Call
}
...
func (_c *MockStore_Run3DMigration_Call) Return(_a0 error) *MockStore_Run3DMigration_Call {
	_c.Call.Return(_a0)
	return _c
}
