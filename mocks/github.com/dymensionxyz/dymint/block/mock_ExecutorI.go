...
// UpdateStateAfterCommit provides a mock function with given fields: s, resp, appHash, height
func (_m *MockExecutorI) UpdateStateAfterCommit(s *types.State, resp *state.ABCIResponses, appHash []byte, height uint64) {
	_m.Called(s, resp, appHash, height)
}
...
//   - appHash []byte
//   - height uint64
func (_e *MockExecutorI_Expecter) UpdateStateAfterCommit(s interface{}, resp interface{}, appHash interface{}, height interface{}) *MockExecutorI_UpdateStateAfterCommit_Call {
	return &MockExecutorI_UpdateStateAfterCommit_Call{Call: _e.mock.On("UpdateStateAfterCommit", s, resp, appHash, height)}
}

func (_c *MockExecutorI_UpdateStateAfterCommit_Call) Run(run func(s *types.State, resp *state.ABCIResponses, appHash []byte, height uint64)) *MockExecutorI_UpdateStateAfterCommit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*types.State), args[1].(*state.ABCIResponses), args[2].([]byte), args[3].(uint64))
	})
	return _c
}
...
func (_c *MockExecutorI_UpdateStateAfterCommit_Call) RunAndReturn(run func(*types.State, *state.ABCIResponses, []byte, uint64)) *MockExecutorI_UpdateStateAfterCommit_Call {
	_c.Call.Return(run)
	return _c
}
