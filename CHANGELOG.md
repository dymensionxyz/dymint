...
* **celestia:** use tm mashal/ummarshal celestia headers ([#1446](https://github.com/dymensionxyz/dymint/issues/1446)) ([c80c7e8](https://github.com/dymensionxyz/dymint/commit/c80c7e8e101f6dd331d3fff7fc4e53d26e735472))
...
* **da:** add maturity to availability check for Kaspa ([#1444](https://github.com/dymensionxyz/dymint/issues/1444)) ([0d5f5f9](https://github.com/dymensionxyz/dymint/commit/0d5f5f9d26f1cee03cd7e0dc4391244ffd52a24c))
* **da:** busy loop in grpc when batch not found ([#1434](https://github.com/dymensionxyz/dymint/issues/1434)) ([939b4e7](https://github.com/dymensionxyz/dymint/commit/939b4e71498f19f1edf7150d1167273bbc8b6bc7))
* **da:** celestia config example and readme missing fields ([#1439](https://github.com/dymensionxyz/dymint/issues/1439)) ([4756ca5](https://github.com/dymensionxyz/dymint/commit/4756ca5a547ece195427801b3b497fc60a4944e6))
...
* **da:** improve kaspa tx maturity check when old virtual chain blue score from API ([#1491](https://github.com/dymensionxyz/dymint/issues/1491)) ([6253878](https://github.com/dymensionxyz/dymint/commit/6253878e7f575b3f8204929f9975a4e0879a8334))
...
* **da:** set solana default program and readme fix ([#1465](https://github.com/dymensionxyz/dymint/issues/1465)) ([11284ba](https://github.com/dymensionxyz/dymint/commit/11284baa35613771cbb2dc0cb2f36d5ee4936af0))
* **da:** solana-go repo update ([#1464](https://github.com/dymensionxyz/dymint/issues/1464)) ([b1f8322](https://github.com/dymensionxyz/dymint/commit/b1f8322102037d5725e9cfa83643a000095bea22))
...
* do not send duplicated consensus msgs in case of reboot ([#1222](https://github.com/dymensionxyz/dymint/issues/1222)) ([98a3348](https://github.com/dymensionxyz/dymint/commit/98a3348eb216f7ae259a2f9343cd85f0599f6aa4))
...
* ensure JSON serialization compatibility ([e454904](https://github.com/dymensionxyz/dymint/commit/e4549046b57cce680fb2fc495112b663efedaad1))
...
* **linter:** fixing linter issues  ([#1463](https://github.com/dymensionxyz/dymint/issues/1463)) ([b45a974](https://github.com/dymensionxyz/dymint/commit/b45a974249b6d901821d26a1d02edb21767c423b))
...
* **tee:** add retry to SubmitTEEAttestation() ([#1473](https://github.com/dymensionxyz/dymint/issues/1473)) ([22be960](https://github.com/dymensionxyz/dymint/commit/22be9602dfb3df0b3cea952af39f4a937cae8532))
* **tee:** sequencer should use dry=false in query to TEE node ([#1471](https://github.com/dymensionxyz/dymint/issues/1471)) ([f1f8e9b](https://github.com/dymensionxyz/dymint/commit/f1f8e9b670ed932f2aa6de67d26924d2d234636e))
...
* **da grpc:** retry instead of freeze ([#1315](https://github.com/dymensionxyz/dymint/issues/1315)) ([f5dccaf](https://github.com/dymensionxyz/dymint/commit/f5dccaf803c5613f6ba7fc8734c60236402f901a))
...
* **da:** ethereum da client ([#1426](https://github.com/dymensionxyz/dymint/issues/1426)) ([9bc454a](https://github.com/dymensionxyz/dymint/commit/9bc454a4c43fe9b6ec06527a53673f852c09e4b7))
...
* **da:** kaspa da client ([#1413](https://github.com/dymensionxyz/dymint/issues/1413)) ([874dc82](https://github.com/dymensionxyz/dymint/commit/874dc8236c8fd48c4538b18cb36a3a90542e8027))
...
* **da:** solana da client ([#1423](https://github.com/dymensionxyz/dymint/issues/1423)) ([f740637](https://github.com/dymensionxyz/dymint/commit/f740637110e2a13324b7ef2f0bdeccdf275f09f0))
...
* **fraud:** extend fraud information upon detection ([#1237](https://github.com/dymensionxyz/dymint/issues/1237)) ([377dc7c](https://github.com/dymensionxyz/dymint/commit/377dc7cab0203fca837d201c92f357fe6f70a2ee))
...
* **p2p:** enable blocksync to work with multiple revisions ([#1251](https://github.com/dymensionxyz/dymint/issues/1251)) ([ab04841](https://github.com/dymensionxyz/dymint/commit/ab048412f300d5fa0f710343dcc002de8e288218))
...
* **sl:** add chain id query ([#1477](https://github.com/dymensionxyz/dymint/issues/1477)) ([004b6ea](https://github.com/dymensionxyz/dymint/commit/004b6ea7850ab91f9671cdcccf09578c3085c648))
...
* TEE support  ([#1461](https://github.com/dymensionxyz/dymint/issues/1461)) ([0390e8f](https://github.com/dymensionxyz/dymint/commit/0390e8f137ce2a9444a756afbe88359786261994))
* **tee) (security:** add a finalization check to trusted height and properly support fast finalize genesis ([#1475](https://github.com/dymensionxyz/dymint/issues/1475)) ([5f203c6](https://github.com/dymensionxyz/dymint/commit/5f203c69a8fa9a55aa256475bbab3899ba505705))
* **tee:** state root in nonce ([#1481](https://github.com/dymensionxyz/dymint/issues/1481)) ([97fea84](https://github.com/dymensionxyz/dymint/commit/97fea848df1430e75271b0e5c5c0bf2306775eed))
* **tee:** use updated nonce (inc hub chain ID) ([#1476](https://github.com/dymensionxyz/dymint/issues/1476)) ([4b4ef02](https://github.com/dymensionxyz/dymint/commit/4b4ef026982967c11d0cae3b23091b41b1c67ce1))
...
* Revert "chore(deps): bump github.com/quic-go/quic-go from 0.42.0 to 0.49.1 (#1472)" ([911cbb4](https://github.com/dymensionxyz/dymint/commit/911cbb45b96b2798c535f195586ff6716103c40c)), closes [#1472](https://github.com/dymensionxyz/dymint/issues/1472)
