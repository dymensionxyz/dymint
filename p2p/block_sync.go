...
func StartBlockSync(ctx context.Context, h host.Host, store datastore.Datastore, msgHandler BlockSyncMessageHandler, networkName string, logger types.Logger) (*BlockSync, error) {
